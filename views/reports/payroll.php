...
$totalNet = $totalNet ?? 0;
$filters = $filters ?? ['employee_id' => '', 'department_id' => '', 'period_start' => '', 'period_end' => ''];
...
<div class="sh-card p-3 mb-3 no-print">
  <form method="GET" class="row g-2">
    ...
    <div class="col-md-2"><input type="date" class="form-control" name="period_start" value="<?= e($filters['period_start']) ?>" title="From"></div>
    <div class="col-md-2"><input type="date" class="form-control" name="period_end" value="<?= e($filters['period_end']) ?>" title="To"></div>
