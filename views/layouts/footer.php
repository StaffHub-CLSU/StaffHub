<?php
/**
 * layouts/footer.php — closes the layout shell and loads shared scripts.
 */
use function StaffHub\Support\e;

$extraScripts = $extraScripts ?? '';
$assetBase = (defined('APP_URL') ? rtrim(APP_URL, '/') : '') . '/assets/js';
?>
</div><!-- /.sh-content -->
  </div><!-- /.sh-main -->
</div><!-- /.sh-shell -->
...
<script src="<?= e($assetBase) ?>/theme.js"></script>
<script src="<?= e($assetBase) ?>/app.js"></script>
