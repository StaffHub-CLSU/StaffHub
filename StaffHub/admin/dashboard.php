...
$recentClockIns = $dashboard->getRecentClockIns(5);
$recentClockOuts = $dashboard->getRecentClockOuts(5);
$dailyAttendance = $dashboard->getDailyAttendanceChartData(7);
$monthlyPayroll = $dashboard->getMonthlyPayrollChartData(6);
$deptDistribution = $dashboard->getDepartmentDistributionChartData();
...
<div class="row g-3 mb-4" id="statsRow">
  <div class="col-6 col-xl-2">
    <div class="sh-stat-card">
      ...
      <div>
        <div class="sh-stat-value" data-stat="total_employees"><?= $stats['total_employees'] ?></div>
  ...
  <div class="col-6 col-xl-2">
    <div class="sh-stat-card">
      ...
      <div>
        <div class="sh-stat-value" data-stat="present_today"><?= $stats['present_today'] ?></div>
        <div class="sh-stat-label">Present Today</div>
        <div class="sh-stat-trend up"><i class="fa-solid fa-arrow-up"></i> <?= $stats['present_pct'] ?>% of workforce</div>
      </div>
    </div>
  </div>
  <div class="col-6 col-xl-2">
    <div class="sh-stat-card">
      ...
      <div>
        <div class="sh-stat-value" data-stat="absent_today"><?= $stats['absent_today'] ?></div>
        <div class="sh-stat-label">Absent Today</div>
        <div class="sh-stat-trend <?= $stats['absent_pct'] > 0 ? 'down' : 'flat' ?>"><i class="fa-solid fa-arrow-down"></i> <?= $stats['absent_pct'] ?>% of workforce</div>
      </div>
    </div>
  </div>
  <div class="col-6 col-xl-2">
    <div class="sh-stat-card">
      ...
      <div>
        <div class="sh-stat-value" data-stat="total_attendance_records"><?= $stats['total_attendance_records'] ?></div>
  ...
  <div class="col-6 col-xl-2">
    <div class="sh-stat-card">
      ...
      <div>
        <div class="sh-stat-value" data-stat="payrolls_processed"><?= $stats['payrolls_processed'] ?></div>
  ...
  <div class="col-6 col-xl-2">
    <div class="sh-stat-card">
      ...
      <div>
        <div class="sh-stat-value" data-stat="total_departments"><?= $stats['total_departments'] ?></div>
            ...
            <div class="d-flex align-items-center gap-2">
              <?php if (!empty($c['profile_picture'])): ?>
                <div class="sh-avatar sh-avatar-img">
                  <img src="<?= UPLOAD_URL . e($c['profile_picture']) ?>" alt="<?= e($c['first_name'] . ' ' . $c['last_name']) ?>">
                </div>
              <?php else: ?>
...
<?php
$extraScripts = '<script>
const dailyAttendanceData = ' . json_encode($dailyAttendance) . ';
const monthlyPayrollData = ' . json_encode($monthlyPayroll) . ';
const deptDistributionData = ' . json_encode($deptDistribution) . ';
