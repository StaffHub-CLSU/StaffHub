...
$employeesList = $employeeModel->getAll(['status' => 'active'], 1, 500)['data'];
  ...
  <div class="row g-2">
    <div class="col-md-4">
      <select class="form-select" id="filterPayrollEmployee">
        ...
        <?php foreach ($employeesList as $emp): ?><option value="<?= $emp['employee_id'] ?>"><?= e($emp['first_name'] . ' ' . $emp['last_name']) ?></option><?php endforeach; ?>
      </select>
    </div>
    <div class="col-md-3">
        ...
        <div class="row g-3 mb-3">
          <div class="col-md-6">
            ...
            <select class="form-select" id="sp_employee_id">
              ...
              <?php foreach ($employeesList as $emp): ?><option value="<?= $emp['employee_id'] ?>"><?= e($emp['first_name'] . ' ' . $emp['last_name']) ?> (<?= e($emp['employee_code']) ?>)</option><?php endforeach; ?>
            </select>
          </div>
...
<?php
$extraScripts = '<script src="../assets/js/payroll-admin.js"></script>';
